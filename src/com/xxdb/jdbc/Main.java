...
//        });
        ...
        TestStatementUpdate(new String[]{"select * from t1"});

        //TestStatementInsert(new String[]{"select * from t1"});

        TestStatementDelete(new String[]{"select * from t1"});
    }
    ...
    public static void TestStatementUpdate(String[] sqls) throws Exception{
    ...
    public static void TestStatementInsert(String[] sqls) throws Exception{
        ...
        try{
            ...
            for(String sql : sqls) {
                ...
                rs.next();
                rs.moveToInsertRow();
                rs.updateObject(1,LocalTime.parse("09:33:33"));
                rs.updateObject(2,"A");
                rs.updateObject(3,1000);
                rs.updateObject(4,50.0);
                rs.insertRow();
                rs.close();
            }
    ...
    public static void TestStatementDelete(String[] sqls) throws Exception{
